...
public class FriendsHome {
    ...
    private static final Log log = LogFactory.getLog(FriendsHome.class);
    ...
    public void persist(Friends transientInstance) {
        log.debug("persisting Friends instance");
        try {
    ...
    public Friends merge(Friends detachedInstance) {
        ...
        try {
            Friends result = (Friends) sessionFactory.getCurrentSession()
    ...
    public Friends findById( FriendsId id) {
        log.debug("getting Friends instance with id: " + id);
        try {
            Friends instance = (Friends) sessionFactory.getCurrentSession()
                    .get("Friends", id);
            if (instance==null) {
