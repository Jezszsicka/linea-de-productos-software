...
public class JPanelRound extends JPanel{
	...
	private Color colorPrimario = new Color(100);
    private Color colorSecundario = new Color(0);
    private Color colorContorno = new Color(100);
    private int arcw=20;
    private int arch=20;
    ...
    public JPanelRound(int colorPrimario, int colorSecundario, int colorContorno){
    	super();
    	setOpaque(false);
    	this.colorPrimario=new Color(colorPrimario);
    	this.colorSecundario=new Color(colorSecundario);
    	this.colorContorno=new Color(colorContorno);
    }
