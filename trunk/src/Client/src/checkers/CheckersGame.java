...
public class CheckersGame {
	...
	public void move(int[][] board,int row, int column, int newRow, int newColumn){
	 ...
	 */
	private static boolean canJump(int [][] board,int player, int r1, int c1, int r2, int c2,
			int r3, int c3) {
	 ...
	 * neighboring square.
	 */
	private static boolean canMove(int [][] board,int player, int r1, int c1, int r2, int c2) {
